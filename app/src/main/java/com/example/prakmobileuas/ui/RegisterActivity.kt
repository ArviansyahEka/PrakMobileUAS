    ...
    class RegisterActivity : AppCompatActivity() {
        ...
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            btnRegister.setOnClickListener {
                ...
                registerUser(email, username, password, userType)
            }
        ...
        private fun registerUser(email: String, username: String, password: String, userType: String) {
            // Validasi input (Anda dapat menambahkannya sesuai kebutuhan)
                    ...
                    if (task.isSuccessful) {
                        ...
                        when {
                            task.exception is FirebaseAuthUserCollisionException -> {
                                Toast.makeText(this@RegisterActivity, "Email is already in use. Please use a different email.", Toast.LENGTH_SHORT).show()
                            }
                            else -> {
